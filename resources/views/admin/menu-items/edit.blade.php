        ...
        <form action="{{ route('admin.menu-items.update', $menuItem) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-2 gap-5 mb-5">
                ...
                <div class="col-span-2">
                    ...
                    <textarea name="description" rows="3"
                        class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 transition">{{ old('description', $menuItem->description) }}</textarea>
                </div>
                ...
                <div class="col-span-2">
                    ...
                    <div class="mb-3 flex items-center gap-3">
                        <img src="{{ asset('storage/'.$menuItem->image) }}" class="h-20 w-20 rounded-xl object-cover">
                        <p class="text-gray-400 text-sm">Current photo. Upload new to replace.</p>
                    </div>
                    @endif
                    <div class="border-2 border-dashed border-gray-200 rounded-xl p-6 text-center hover:border-orange-400 transition cursor-pointer"
                        ...
                        <p class="text-gray-400 text-sm">Click to upload new photo</p>
            ...
            <div class="grid grid-cols-3 gap-4 mb-6">
                <label class="flex items-center gap-3 p-3 border border-gray-200 rounded-xl cursor-pointer hover:border-orange-400 transition">
                    <input type="checkbox" name="is_veg" value="1" {{ old('is_veg', $menuItem->is_veg) ? 'checked' : '' }}
